...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "eCent " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"ecenttools.com", "dnsseed.ecenttools.com"},
    {"ecentpool.org", "dnsseed.ecentpool.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"ecenttools.com", "testnet-seed.ecenttools.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. eCent is probably already running."), addrBind.ToString().c_str());
        else
